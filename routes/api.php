...
Route::get('/categories/evenements/{catEvenmt}', [CatEvenmtController::class, 'show']);
...
Route::get('/galeries/sites/{galerieSite}', [GalerieSiteController::class, 'show']);
Route::get('/galeries/evenements',                 [GallerieEvnmtController::class, 'index']);
Route::get('/galeries/evenements/{gallerieEvnmt}', [GallerieEvnmtController::class, 'show']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::put('/categories/sites/{catSite}',    [CatSiteController::class, 'update']);
        Route::delete('/categories/sites/{catSite}', [CatSiteController::class, 'destroy']);

        Route::post('/categories/evenements',               [CatEvenmtController::class, 'store']);
        Route::put('/categories/evenements/{catEvenmt}',    [CatEvenmtController::class, 'update']);
        Route::delete('/categories/evenements/{catEvenmt}', [CatEvenmtController::class, 'destroy']);
        ...
        // Modération avis
        Route::patch('/avis/{avi}/approuver', [AvisController::class, 'approuver']);
        ...
        Route::post('/fonctionnalites/{fonctionnalite}/assigner-admin', [FonctionnaliteController::class, 'assignerAdmin']);
        Route::post('/fonctionnalites/{fonctionnalite}/assigner-user',  [FonctionnaliteController::class, 'assignerUser']);
    });
});