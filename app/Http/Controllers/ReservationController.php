...
class ReservationController extends Controller
{
    #[OA\Get(
        ...
        parameters: [
            new OA\Parameter(name: "id_user", in: "query", schema: new OA\Schema(type: "integer")),
            ...
            new OA\Parameter(name: "type", in: "query", schema: new OA\Schema(type: "string", enum: ["site", "evenement"]))
        ],
    ...
    public function index(Request $request)
    {
        ...
        if ($request->filled('id_user')) $query->where('id_user', $request->id_user);
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            content: new OA\JsonContent(
                ...
                properties: [
                    new OA\Property(property: "type", type: "string", example: "site"),
        ...
        responses: [new OA\Response(response: 201, description: "Réservation créée")]
    )]
    public function store(Request $request)
    {
        ...
        return response()->json($reservation->load(['user', 'site', 'evenement', 'tickets']), 201);
    }
    ...
    #[OA\Get(
        ...
        responses: [new OA\Response(response: 200, description: "Détails de la réservation")]
    )]
    public function show(Reservation $reservation)
    {
        return response()->json($reservation->load(['user', 'site', 'evenement', 'tickets.utilisations.avis']));
    }
    ...
    #[OA\Put(
        ...
        responses: [new OA\Response(response: 200, description: "Réservation mise à jour")]
    )]
    public function update(Request $request, Reservation $reservation)
    {
        ...
        return response()->json($reservation->load(['user', 'site', 'evenement', 'tickets']));
    }
    ...
    #[OA\Delete(
        ...
        parameters: [new OA\Parameter(name: "id", in: "path", required: true, schema: new OA\Schema(type: "integer"))],
        responses: [new OA\Response(response: 200, description: "Réservation annulée")]
    )]
