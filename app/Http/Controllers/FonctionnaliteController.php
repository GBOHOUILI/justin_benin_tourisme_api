...
class FonctionnaliteController extends Controller
{
    #[OA\Get(
        ...
        responses: [new OA\Response(response: 200, description: "Liste des fonctionnalités")]
    )]
        ...
        requestBody: new OA\RequestBody(
            content: new OA\JsonContent(
                ...
                properties: [
                    ...
                    new OA\Property(property: "type", type: "string", enum: ["admin", "user", "both"])
                ]
            )
        ),
        responses: [new OA\Response(response: 201, description: "Fonctionnalité créée")]
    )]
    ...
    #[OA\Get(
        path: "/fonctionnalites/{id}",
        tags: ["Fonctionnalites"],
        summary: "Afficher une fonctionnalité",
        parameters: [new OA\Parameter(name: "id", in: "path", required: true, schema: new OA\Schema(type: "integer"))],
        responses: [new OA\Response(response: 200, description: "Détails de la fonctionnalité")]
    )]
    ...
    #[OA\Put(
        ...
        responses: [new OA\Response(response: 200, description: "Fonctionnalité mise à jour")]
    )]
    ...
    #[OA\Delete(
        ...
        parameters: [new OA\Parameter(name: "id", in: "path", required: true, schema: new OA\Schema(type: "integer"))],
        responses: [new OA\Response(response: 200, description: "Fonctionnalité supprimée")]
    )]
    ...
    #[OA\Post(
        path: "/fonctionnalites/{id}/assigner-admin",
        tags: ["Fonctionnalites"],
        ...
        responses: [new OA\Response(response: 200, description: "Accès admin attribué")]
    )]
    public function assignerAdmin(Request $request, Fonctionnalite $fonctionnalite)
    {
        $request->validate(['id_admin' => 'required|exists:admins,id', 'status' => 'nullable|boolean']);
        $fonctionnalite->admins()->syncWithoutDetaching([$request->id_admin => ['status' => $request->status ?? true]]);
        return response()->json(['message' => 'Accès admin attribué']);
    }

    #[OA\Post(
        path: "/fonctionnalites/{id}/assigner-user",
        tags: ["Fonctionnalites"],
        ...
        responses: [new OA\Response(response: 200, description: "Accès utilisateur attribué")]
    )]
    public function assignerUser(Request $request, Fonctionnalite $fonctionnalite)
    {
        $request->validate(['id_user' => 'required|exists:users,id', 'status' => 'nullable|boolean']);
        $fonctionnalite->users()->syncWithoutDetaching([$request->id_user => ['status' => $request->status ?? true]]);
