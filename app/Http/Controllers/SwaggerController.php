...
#[OA\Info(
    ...
    contact: new OA\Contact(email: "ajustinsena@gmail.com")
)]
#[OA\Server(
...
class SwaggerController extends Controller
{
            ...
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        ...
                        new OA\Property(property: "message", type: "string", example: "Benin Tourisme API is running")
                    ]
                )
            )
        ]
    ...
    {
        return response()->json(['status' => 'ok', 'message' => 'Benin Tourisme API is running']);
    }
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: "message", type: "string", example: "Test Swagger OK")
                    ]
                )
            )
        ]
    ...
    public function index()
    {
        return response()->json([
            'message' => 'Test Swagger OK - Le scanner détecte bien les PathItems'
        ]);
    }
}