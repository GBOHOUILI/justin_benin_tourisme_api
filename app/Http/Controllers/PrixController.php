...
class PrixController extends Controller
{
    #[OA\Get(
        ...
        responses: [new OA\Response(response: 200, description: "Liste des prix")]
    )]
    ...
    #[OA\Post(
        ...
        responses: [new OA\Response(response: 201, description: "Prix créé")]
    )]
    public function store(Request $request)
    {
        ...
        if (empty($validated['id_site']) && empty($validated['id_evnmt'])) {
            return response()->json(['message' => 'Un site ou un événement est requis'], 422);
        }
    ...
    #[OA\Get(
        ...
        responses: [new OA\Response(response: 200, description: "Détails du prix")]
    )]
    ...
    #[OA\Put(
        ...
        responses: [new OA\Response(response: 200, description: "Prix mis à jour")]
    )]
    ...
    #[OA\Delete(
        ...
        parameters: [new OA\Parameter(name: "id", in: "path", required: true, schema: new OA\Schema(type: "integer"))],
        responses: [new OA\Response(response: 200, description: "Prix supprimé")]
    )]
