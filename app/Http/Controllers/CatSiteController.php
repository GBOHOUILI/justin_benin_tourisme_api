...
class CatSiteController extends Controller
{
    ...
    #[OA\Post(
        path: "/api/admin/categories/sites",
        tags: ["Categories Sites"],
        summary: "Créer une catégorie de site (admin)",
        security: [["bearerAuth" => []]],
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                required: ["libelle"],
                properties: [
                    new OA\Property(property: "libelle", type: "string", example: "Patrimoine Historique"),
                ],
            ),
        ),
        responses: [
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            "libelle" => "required|string|max:150|unique:cat_site",
        ]);
    ...
    #[OA\Put(
        path: "/api/admin/categories/sites/{id}",
        tags: ["Categories Sites"],
        summary: "Mettre à jour une catégorie de site (admin)",
        security: [["bearerAuth" => []]],
        parameters: [
            new OA\Parameter(name: "id", in: "path", required: true, schema: new OA\Schema(type: "integer")),
        ],
    ...
    {
        $validated = $request->validate([
            "libelle" => "required|string|max:150|unique:cat_site,libelle," . $catSite->id,
        ]);
    ...
    #[OA\Delete(
        path: "/api/admin/categories/sites/{id}",
        tags: ["Categories Sites"],
        summary: "Supprimer une catégorie de site (admin)",
        security: [["bearerAuth" => []]],
        parameters: [
            new OA\Parameter(name: "id", in: "path", required: true, schema: new OA\Schema(type: "integer")),
        ],
