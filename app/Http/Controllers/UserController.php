...
class UserController extends Controller
{
    #[OA\Get(
        ...
        responses: [new OA\Response(response: 200, description: "Liste des utilisateurs paginée")]
    )]
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                required: ["nom", "prenom", "tel", "email", "password", "password_confirmation"],
                properties: [
                    new OA\Property(property: "nom", type: "string", example: "Doe"),
                    new OA\Property(property: "prenom", type: "string", example: "John"),
                    new OA\Property(property: "tel", type: "string", example: "+22901000000"),
                    new OA\Property(property: "email", type: "string", example: "john@example.com"),
                    new OA\Property(property: "password", type: "string", example: "password123"),
                    new OA\Property(property: "password_confirmation", type: "string", example: "password123"),
                    new OA\Property(property: "nationalite", type: "string", example: "Béninoise"),
    ...
    {
        return response()->json($user->load(['reservations.tickets', 'fonctionnalites']));
    }
