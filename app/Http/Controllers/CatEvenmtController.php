...
class CatEvenmtController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            "libelle" => "required|string|max:150|unique:cat_evenmts",
        ]);
    ...
    public function update(Request $request, CatEvenmt $catEvenmt)
    {
        $validated = $request->validate([
            "libelle" =>
                "required|string|max:150|unique:cat_evenmts,libelle," .
                $catEvenmt->id,
        ]);
    ...
    public function destroy(CatEvenmt $catEvenmt)
    {
        ...
        return response()->json(
            ["message" => "Catégorie événement supprimée"],
            200,
        );
    }
}
