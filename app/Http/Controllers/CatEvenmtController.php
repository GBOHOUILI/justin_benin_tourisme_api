...
{
    #[OA\Get(
        path: "/api/categories/evenements",
    ...
    #[OA\Post(
        path: "/api/admin/categories/evenements",
        tags: ["Categories Evenements"],
        summary: "Créer une catégorie d'événement (admin)",
        security: [["bearerAuth" => []]],
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                required: ["libelle"],
                properties: [
                    new OA\Property(property: "libelle", type: "string", example: "Festival"),
                ],
            ),
        ),
        responses: [
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            "libelle" => "required|string|max:150|unique:cat_evenmt",
        ]);
    ...
    #[OA\Get(
        path: "/api/categories/evenements/{id}",
        tags: ["Categories Evenements"],
    ...
    #[OA\Put(
        path: "/api/admin/categories/evenements/{id}",
        tags: ["Categories Evenements"],
        summary: "Mettre à jour une catégorie d'événement (admin)",
        security: [["bearerAuth" => []]],
        parameters: [
            new OA\Parameter(name: "id", in: "path", required: true, schema: new OA\Schema(type: "integer")),
        ],
    ...
    {
        $validated = $request->validate([
            "libelle" => "required|string|max:150|unique:cat_evenmt,libelle," . $catEvenmt->id,
        ]);
    ...
    #[OA\Delete(
        path: "/api/admin/categories/evenements/{id}",
        tags: ["Categories Evenements"],
        summary: "Supprimer une catégorie d'événement (admin)",
        security: [["bearerAuth" => []]],
        parameters: [
            new OA\Parameter(name: "id", in: "path", required: true, schema: new OA\Schema(type: "integer")),
        ],
